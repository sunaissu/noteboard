...
- **Locked-element enforcement and undo history** — Canvas gestures, keyboard shortcuts, context-menu actions, grouping, ordering, alignment, erasing, text editing, and property changes consistently preserve locked elements, while property edits and imports now record the correct pre-change snapshot.
